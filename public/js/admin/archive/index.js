...
function init_data_table(status) {
    let url = {
        all: "/admin/archive/all/paging",
        publish: "/admin/archive/publish/paging",
        unpublish: "/admin/archive/unpublish/paging",
    };
    let table = $('#dt_archive');
    if (table != null) {
        table.DataTable({
            order:[10,'desc'],
            responsive: {
            ...
            columnDefs: [
                ...
                },
                {
                    targets: 9,
                    render: function(data, type, full, meta) {
                        return '<a href="/assets/upload/archive/'+full.code+'/'+data+'" target="_blank">'+data+'</a>';
                    }
                },
                {
                    targets:10,
                ...
                },
                {
                    ...
                    className: "text-center",
                    render: function(data, type, full, meta) {
                        return '<a href="/admin/archive/edit/'+data+'" class="btn btn-datatable btn-icon btn-transparent-dark btn-sm p-0 mr-2"><i class="fas fa-edit"></i></a>' +
                            '<a target="_blank" href="admin/archive/edit/'+data+'" class="btn btn-datatable btn-icon btn-transparent-dark btn-sm p-0"><i class="fas fa-eye"></i></a>';
                    },
                }
            ],
        });
