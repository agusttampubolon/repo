...
function init_data_table(status) {
    let url = {
        all: "/admin/others/all/paging",
        publish: "/admin/others/publish/paging",
        unpublish: "/admin/others/unpublish/paging",
    };
    let table = $('#dt_others');
    if (table != null) {
        table.DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    targets: 9,
                    render: function(data, type, full, meta) {
                        return '<a href="/assets/upload/others/'+full.code+'/'+data+'" target="_blank">'+data+'</a>';
                    }
                },
                {
                    targets:10,
                ...
                },
                {
                    ...
                    className: "text-center",
                    render: function(data, type, full, meta) {
                        return '<a href="/admin/others/edit/'+data+'" class="btn btn-datatable btn-icon btn-transparent-dark btn-sm p-0 mr-2"><i class="fas fa-edit"></i></a>' +
                            '<a target="_blank" href="admin/others/edit/'+data+'" class="btn btn-datatable btn-icon btn-transparent-dark btn-sm p-0"><i class="fas fa-eye"></i></a>';
                    },
                }
            ],
        });
