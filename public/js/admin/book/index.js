        ...
        table.DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    targets: 8,
                    render: function(data, type, full, meta) {
                        return '<a href="/assets/upload/book/'+full.code+'/'+data+'" target="_blank">'+data+'</a>';
                    }
                },
                {
                    targets:9,
                ...
                },
                {
                    ...
                    className: "text-center",
                    render: function(data, type, full, meta) {
                        return '<a href="/admin/book/edit/'+data+'" class="btn btn-datatable btn-icon btn-transparent-dark btn-sm p-0 mr-2"><i class="fas fa-edit"></i></a>' +
                            '<a target="_blank" href="admin/book/edit/'+data+'" class="btn btn-datatable btn-icon btn-transparent-dark btn-sm p-0"><i class="fas fa-eye"></i></a>';
                    },
                }
            ],
        });
