                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="sb-datatable table-responsive">
                            <table class="table table-striped responsive table-bordered nowrap" id="dt_monograph" width="100%" cellspacing="0">
                                <thead>
                                <tr>
...
@section('js')
    <script src="{{url('/js/admin/monograph/index.js')}}" type="text/javascript"></script>
