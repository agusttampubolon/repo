        ...
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="issued_date" required>
                        @foreach(Helper::get_year() as $year)
                            <option value="{{$year}}" {{$year == $issued_date ? "selected" : ""}}>{{$year}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select class="form-control" name="submitted" required>
                        @foreach(Helper::get_year() as $year)
                            <option value="{{$year}}" {{$year == $submitted ? "selected" : ""}}>{{$year}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
